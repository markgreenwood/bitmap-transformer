...
function Bitmap(filename, cb) {
  ...
  let self = this; // apparently this is necessary to propagate 'this' Bitmap into the callback
...
// .transform() invokes various transformations based on the label
// you pass it, along with arguments for the specific transform you choose
...
// .redderImage() makes the image redder by a specified factor
...
// .greenerImage() makes the image greener by a specified factor
...
// .bluerImage() makes the image bluer by a specified factor
...
// .invertColors "inverts" the colors, i.e. new_color = 255 - old_color
...
// .grayScale makes the colors "grayer", i.e. multiplies everything by a factor
...
// .copyColorTable returns a deep copy of the color table, primarily for testing
...
// .copyImageData returns a deep copy of the image data, primarily for testing
...
// .updateBufferColorTable updates the binary data buffer from the color table object
...
// .updateBufferImageData updates the binary data buffer from the image data object
...
// .writeBufferToFile writes the (presumably altered) binary data buffer to a new .bmp file
